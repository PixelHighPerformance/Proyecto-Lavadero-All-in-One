...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update'])) {
    ...
    $tipo = $_POST['tipo'];
    $descuento = floatval($_POST['descuento']); // Convertir a decimal
    ...
    if (!in_array($tipo, $tipos_validos)) {
        ...
        if ($stmt) {
            ...
            $mensaje = "Error al preparar la consulta de modificación.";
        }
    }
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add'])) {
    ...
    if (!in_array($tipo, $tipos_validos)) {
        ...
        if ($stmt) {
            ...
            $mensaje = "Error al preparar la consulta de agregado.";
        }
    }
}
?>
